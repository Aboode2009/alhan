...
public class AlhanMediaService extends MediaSessionService {
        ...
        mediaSession = new MediaSession.Builder(this, player)
                ...
                .setCallback(new MediaSession.Callback() {
                    ...
                    public MediaSession.ConnectionResult onConnect(
                        ...
                        // Allow all system controllers (lock screen, Bluetooth, etc.)
    ...
    // ── Static control surface (called from MediaPlayerPlugin) ──────────────
    ...
    public static synchronized long getPosition() {
        return (instance != null && instance.player != null)
                ? instance.player.getCurrentPosition() : 0;
    }
    ...
    /** Keep the service alive while audio is playing (e.g. user swipes app away). */
    @Override
    public void onTaskRemoved(Intent rootIntent) {
        if (player != null && player.isPlaying()) return; // keep running
        stopSelf();
    }
