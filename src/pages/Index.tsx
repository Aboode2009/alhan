...
const Index = () => {
  ...
  const searchYouTube = async (query: string) => {
    ...
    try {
      ...
      toast({ title: "البحث غير متاح", description: "تعذر الاتصال بخدمة البحث. تأكد من اتصال الإنترنت ثم حاول مرة أخرى.", variant: "destructive" });
      setSongs([]);
